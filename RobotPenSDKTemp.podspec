Pod::Spec.new do |s|
  ...
  s.subspec 'RobotBoardSDK' do |board|
    ...
    board.dependency 'RobotPenSDKTemp/RobotPenSDK'
  end
  ...
  s.subspec 'RobotRecordSDK' do |record|
    ...
    record.dependency 'RobotPenSDKTemp/RobotBoardSDK'
  end
